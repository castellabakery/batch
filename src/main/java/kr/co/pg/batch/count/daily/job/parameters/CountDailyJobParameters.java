package kr.co.pg.batch.count.daily.job.parameters;
...
@Getter
@ToString
public class CountDailyJobParameters implements DefaultJobParameters, JobParametersDetail {

    private static final DateTimeFormatter DATE_FORMATTER = DateFormatUtils.DASH_DATE;
    ...
    public CountDailyJobParameters() {
    }

    public CountDailyJobParameters(LocalDate standardDate, String adminId) {
        this.standardDate = standardDate;
        this.adminId = adminId;
    }

    public CountDailyJobParameters(String standardDate, String adminId) {
        setStandardDate(standardDate);
        setAdminId(adminId);
    }

    public CountDailyJobParameters(String adminId) {
    ...
    public void setStandardDate(String standardDate) throws IllegalArgumentException {
        try {
