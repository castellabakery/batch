package kr.co.pg.batch.reconcile.van.k.job.parameters;
...
@Getter
@ToString
public class KVanReconcileJobParameters implements DefaultJobParameters, JobParametersDetail {
    ...
    public KVanReconcileJobParameters() {
    }

    public KVanReconcileJobParameters(LocalDate standardDate, String adminId) {
	    this.standardDate = standardDate;
	    this.adminId = adminId;
    }

    public KVanReconcileJobParameters(String standardDate, String adminId) {
        this(LocalDate.parse(standardDate, DATE_FORMATTER), adminId);
    }

    public KVanReconcileJobParameters(String adminId) {
